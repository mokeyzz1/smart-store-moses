...
This script reads sales data from the data/raw folder, cleans it using the reusable DataScrubber class,
and writes the cleaned version to the data/prepared folder.

To Run:
$ source .venv/bin/activate
$ python scripts/data_preparation/prepare_sales_data.py
"""
...
def main() -> None:
    ...
    scrubber.format_column_strings_to_upper_and_trim("paymenttype")
